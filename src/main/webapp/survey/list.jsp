  ...
  <TR>
    ...
    <c:choose>   
         <c:when test="${manager_surveyVO.q_cnt==0}">
           <button type="button" class="btn btn-primary "onclick="exit();" style="width:40%;margin-top:-5px;" >응시 불가</button>
         </c:when>
         <c:otherwise>
            <button type="button" class="btn btn-primary "onclick="location.href='../surveyitem/party_list.do?surveyno=${manager_surveyVO.surveyno}&mno=1'" style="width:40%;margin-top:-5px;">응시 가능</button>
         </c:otherwise>
    </c:choose>
