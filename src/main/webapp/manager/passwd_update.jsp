...
<DIV class='title_line' >패스워드 변경</DIV>
  ...
  <!-- <ASIDE style='float: right;'>
    <A href="javascript:location.reload();">새로고침 &nbsp</A> 
    <span class='menu_divide' >│</span> 
...
<!--   <div class='menu_line'></div>
  ...
  <FORM name='frm' method='POST' action='./passwd_update.do' 
    ...
    <br>
        ...
        <button type="button" onclick="location.href='./read.do?managerno=${managerno }'" class="btn btn-primary btn-md">취소</button>
