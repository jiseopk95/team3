   ...
   <br>             
    패스워드
      <!-- <label for="passwd" >패스워드</label> -->    
        <input type='password' name='passwd' id='passwd' value='' required="required" style='width: 20%;' placeholder=""> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
     
    <input type='hidden' name='kind' id='kind' value='N'>
    <br>
   <br>
   패스워드 확인
      <!-- <label for="passwd2" >패스워드 확인</label>  -->   
        <input type='password'  name='passwd2' id='passwd2' value='' required="required" style='width: 20%;' placeholder=""> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
     <br><br>
    ...
    성명
      <!-- <label for="name" >성명</label>   -->  
        ...
        <input type='text' name='name' id='name' 
                   value='' required="required" style='width: 20%;' placeholder="">  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
     <br><br>
     직급
