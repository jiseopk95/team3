...
<script type="text/javascript">
  ...
  function res_info() {
    alert("캘린더에서 희망하는 예약 날짜를 클릭해주십시오.\n\n"
        		+"----------------------- 진료시간 ----------------------\n"
        		+"평일 10AM~7PM / 주말 10AM~5PM ( 일요일 휴진 ) ");
  }
</script>
</head>
<body>
...
String date_list = Integer.toString(cal.get(Calendar.DATE));
...
<DIV class='container' >
  <DIV class='content'  style='margin:0px auto; text-align: center; margin-top: 5%; margin-bottom:5%'>
    <div class="buttons" style="float: right;">
      <button type="button" id="create_reservation" class="btn btn-primary" onclick="location.href='../reservation/my_list.do?memberno=<%=memberno%>&date=<%=today%>'">내 예약 리스트</button>
    	  ...
    	  <td>
            ...
            while (cal.get(Calendar.MONTH) == month) {
              ...
              if (cal.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY){
                out.println("<td class='calendar_td' valign='top' style='text-align: right; border-right:none;'><a style='color:#337ab7d9 !important;' href='javascript:reservation(" + cal.get(Calendar.YEAR) + "," + cal.get(Calendar.MONTH) + "," + cal.get(Calendar.DATE) +")'>" + cal.get(Calendar.DATE) + "</a>");
              }else if (cal.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY){
                out.println("<td class='calendar_td' valign='top' style='text-align: right; border-left:none;'><a style='color:#dd3a15c7 !important;' href='javascript:reservation(\"sun\")'>" + cal.get(Calendar.DATE) + "</a>");
              }else{
              ...
              if (list != null){ 
                ...
                for(int i=0; i<list.size(); i++){
                  ...
                  sb.append("<a href='javascript:read("+calendarVO.getReservationno()+")'>"+calendarVO.getLabel()+"</a><br>");            
                }
