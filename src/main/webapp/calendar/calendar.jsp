...
<button type="button" id="create_reservation" class="btn btn-primary" style="float: right;" onclick="location.href='../reservation/my_list.do?memberno=<%=memberno%>&date=<%=today%>'">내 예약 리스트</button>
