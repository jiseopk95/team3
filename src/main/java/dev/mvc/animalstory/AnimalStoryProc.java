...
import dev.mvc.chart.chart_paging;
...
public class AnimalStoryProc implements AnimalStoryProcInter{
  ...
  @Override
  public ArrayList<AniFileVO> getThumbs(AnimalStoryVO aniVO) {
    ArrayList<AniFileVO> file_list = new ArrayList<AniFileVO>();
    ...
    if (files.length() > 0) {
      for (int index = 0; index < count; index++) {
        ...
        AniFileVO fileVO = new AniFileVO(thumbs_array[index], files_array[index], sizes_array[index]);
